    ...
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetContent side="left" className="w-[85vw] max-w-[280px] p-0">
        ...
        <div className="border-t p-4 space-y-3">
          ...
          {/* Mobile app notice */}
          <div className="rounded-xl bg-gradient-to-br from-blue-50 to-indigo-100 p-4 dark:from-blue-900/20 dark:to-indigo-900/20">
            ...
            <p className="mt-1 text-xs text-blue-700 dark:text-blue-300">
              iOS & Android apps are in development
            </p>
          </div>

          {/* Limited bank access notice */}
          <div className="rounded-xl bg-gradient-to-br from-amber-50 to-orange-100 p-4 dark:from-amber-900/20 dark:to-orange-900/20">
            <div className="flex items-center gap-2">
            ...
            <p className="mt-1 text-xs text-amber-700 dark:text-amber-300">
              Major banks (Chase, Bank of America, Wells Fargo) coming soon
            </p>
          </div>
        </div>
      </SheetContent>
