...
const cspHeader = `
  ...
  img-src 'self' blob: data: https://logo.clearbit.com https://www.google.com https://*.gstatic.com https://*.stripe.com https://*.plaid.com https://plaid.com https://*.vercel.app;
  font-src 'self';
